...
export const projectTemplates = {
  express: {
    ...
    entryFilePath: 'src/index.js',
    files: [
      { path: 'src', type: 'folder', language: '', content: '' },
      { path: 'src/index.js', type: 'file', language: 'javascript', content: defaultExpressCode },
    ],
  },
  rest: {
    id: 'rest',
...
`,
    ...
    files: [
      { path: 'src', type: 'folder', language: '', content: '' },
      { path: 'src/index.js', type: 'file', language: 'javascript', content: `const express = require("express");
const app = express();
